...
@Component({
  ...
  template: `
    <main class="min-h-screen bg-shell px-4 py-6 md:px-8 md:py-10">
      <section class="mx-auto max-w-2xl rounded-3xl border border-white/60 bg-white/90 p-8 shadow-xl shadow-cyan-950/10 backdrop-blur md:p-10">
        ...
        <p class="mt-2 text-sm text-slate-600">
          Crea tu acceso para entrar al dashboard y gestionar el inventario.
        </p>
